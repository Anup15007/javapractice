...
public class Associate{
	...
	public String toString() {
		return "Associate [associateId=" + associateId + ", yearlyInvestmentUnder80C=" + yearlyInvestmentUnder80C
				...
				+ salary + ", bankDetails=" + bankDetails + ", hashCode()=" + hashCode() + ", getAssociateId()="
				+ getAssociateId() + ", getYearlyInvestmentUnder80C()=" + getYearlyInvestmentUnder80C()
				+ ", getFirstName()=" + getFirstName() + ", getLastName()=" + getLastName() + ", getDepartment()="
				+ getDepartment() + ", getDesignation()=" + getDesignation() + ", getPancard()=" + getPancard()
				+ ", getEmailId()=" + getEmailId() + ", getClass()=" + getClass() + ", toString()=" + super.toString()
				+ "]";
	}
